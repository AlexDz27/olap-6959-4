...
function EnterIcon() {
  return (
    <svg
      className="add-task__enter-icon"
      width="20px" height="20px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
    >
      <g id="🔍-System-Icons" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g id="ic_fluent_arrow_enter_24_filled" fill="#212121" fillRule="nonzero">
